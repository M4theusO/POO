...
public class Principal {
	...
	private static Operacoes oper = new Operacoes(); //ATRIBUTO. Um método ou atributo dinâmico pode ser acessado somente por uma 
													 //instância da classe, ou seja, somente pela criação de um objeto.
	// CONSTRUTOR "prepara” o objeto criado de acordo com o que for preciso
