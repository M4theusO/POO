...
public class EntradaSaida {
	...
	public static int solicitaOpcao() { //deve ter retorno int pois retorna a opção que o usuario selecionou, nesse caso teria 4 opcoes, comecando da "posiçao 0" ate 3, sendo 3 a saida do programa.
		...
		return menu.getSelectedIndex(); //mostra em que posição está o item selecionado(menu = 0 ou 1 ou 2 ou 3) 
	}
	...
	public static int solicitaEstado(String tipoAbertura) {
		...
		return JOptionPane.showOptionDialog(null, "Informe o estado da " + tipoAbertura, "Estado", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, opcoes, opcoes[1]); //pois fornecemos 2 opçoes
	}
	...
	public static int solicitaAberturaMover(ArrayList<Aberturas>listaDeAberturas) {
		...
		String tipoAbertura = listaDeAberturas.get(0).getClass().getName();//ultimo método passa o retorno final
	...
	public static void exibeInfoCasa(String informacoes) {
		JOptionPane.showMessageDialog(null, informacoes, "Informações de casa",
